...
class SignUpFailedDemo extends StatefulWidget {
  const SignUpFailedDemo({super.key});

  @override
  State<SignUpFailedDemo> createState() => _SignUpFailedDemoState();
}

class _SignUpFailedDemoState extends State<SignUpFailedDemo> {
  @override
      ...
      body: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              'create an account to continue our service',
